...
const fs = require("fs");
const ws1 = fs.createWriteStream("ar_part1.csv");
const ws2 = fs.createWriteStream("ar_part2.csv");
const ws3 = fs.createWriteStream("ar_part3.csv");

const url = "https://www.alrawitheorie.nl/free-exam/77?lang=ar";
