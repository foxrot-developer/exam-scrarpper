...
const fs = require("fs");
const ws1 = fs.createWriteStream("en4_part1.csv");
const ws2 = fs.createWriteStream("en4_part2.csv");
const ws3 = fs.createWriteStream("en4_part3.csv");

const url = "https://www.alrawitheorie.nl/exam/11/subscription/17137?lang=en";
    ...
    for (i = 1; i <= 12; i++) {
        const result2 = await page.evaluate(() => {
            if (document.querySelector("#app > main > div > div.row > div.col-12.col-md-12 > div > div > div.row.my-4.question-options > div > button:nth-child(1)")) {
                return {
                    question: document.querySelector("#app > main > div > div.row > div.col-12.col-md-12 > div > div > div:nth-child(1) > div > h5").innerText,
                    option1: document.querySelector("#app > main > div > div.row > div.col-12.col-md-12 > div > div > div.row.my-4.question-options > div > button:nth-child(1)").innerText,
                    option2: document.querySelector("#app > main > div > div.row > div.col-12.col-md-12 > div > div > div.row.my-4.question-options > div > button:nth-child(2)").innerText,
                    option3: '',
                    reason: document.querySelector("#reason-modal > div > div > div:nth-child(2)").innerText,
                    image: ''
                };
